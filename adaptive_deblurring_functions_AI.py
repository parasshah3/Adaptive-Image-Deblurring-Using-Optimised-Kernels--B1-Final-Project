...
def kernel_library_extended(high_scaling_factor, gaussian_variance, brightness_factor, edge_scaling_factor):
    ...
    - High variance & high gradient.
    - Low variance & low gradient.
    - Low variance & high gradient.
    - High variance & low gradient.
    """
    def gaussian_kernel(size, variance):
    ...
    return {
        ...
        "low_var_high_grad": edge_scaling_factor * np.array([[1, -2, 1],
                                                             [-2, 5, -2],
                                                             [1, -2, 1]]),  # Edge enhancement
        "high_var_low_grad": np.array([[0, -1, 0],
                                       [-1, 5, -1],
