...
# Load the image
image_path = "/Users/paras/Desktop/B1 Final Project/defocused building.JPG"  # Update with your image path
input_image = load_image(image_path)

# Define parameters
gaussian_variance = 1.0       # Variance for the Gaussian blur kernel
high_scaling_factor = 1.6     # Scaling factor for high-pass kernels
brightness_factor = 0.30       # Brightness adjustment for low-pass kernels
